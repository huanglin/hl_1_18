...
/*WM8994_R8  Clocking and Sample Rate*/
...
/*WM8994_R10^^WM8994_R11 Left and Right  Channel Digital Volume*/
...
#define WM8994_RESET     0x00  // 0x0f
#define WM8994_3D        0x10
#define WM8994_ALC1      0x11
#define WM8994_ALC2      0x12
#define WM8994_ALC3      0x13  
#define WM8994_NGATE     0x14
#define WM8994_LADC      0x15			/*Left ADC volume*/
#define WM8994_RADC      0x16		/*Right ADC volume*/
#define WM8994_ADCTL1    0x17		/*Additional control(1)*/
#define WM8994_ADCTL2    0x18		/*Additional control(2)*/
#define WM8994_PWR1      0x19		/*Pwr Mgmt(1)*/
#define WM8994_PWR2      0x1a		/*Pwr Mgmt(2)*/
#define WM8994_ADCTL3    0x1b
#define WM8994_ADCIN     0x1f		/*ADC input Mode*/
#define WM8994_LADCIN    0x20		/*ADCL signal path*/
#define WM8994_RADCIN    0x21		/*ADCR signal path*/
#define WM8994_LOUTM1    0x22
#define WM8994_LOUTM2    0x23
#define WM8994_ROUTM1    0x24
#define WM8994_ROUTM2    0x25
#define WM8994_MOUTM1    0x26
#define WM8994_MOUTM2    0x27
#define WM8994_LOUT2V    0x28
#define WM8994_ROUT2V    0x29
#define WM8994_MOUTV     0x2a

#define WM8994_CACHE_REGNUM 0x2a

#define	WM8994_LOW_POWER_PLAYBACK		0x43 
...
extern struct snd_soc_codec_dai wm8994_dai;

/*
 * rockchip_wm8994.c  --  SoC audio for rockchip
 *
...
{    
    ...
    DBG("Enter::%s----%d\n",__FUNCTION__,__LINE__);   
	  ...
	  ret = codec_dai->dai_ops.set_sysclk(codec_dai, 0,  ///WM8994_SYSCLK,
...
static const char *audio_map[][3] = {
	...
	/* mic is connected to Mic Jack, with WM8994 Mic Bias */
	{"MICIN", NULL, "Mic Bias"},
...
static struct snd_soc_dai_link rockchip_dai = {
	  ...
	  .init = rockchip_wm8994_init,
	  .ops = &rockchip_ops,
};

static struct snd_soc_machine snd_soc_machine_rockchip = {
	  .name = "ROCKCHIP_WM8994",
	  .dai_link = &rockchip_dai,
	  .num_links = 1,
};

static struct wm8994_setup_data rockchip_wm8994_setup = {
	  .i2c_address = 0x1a,
};
...
static struct snd_soc_device rockchip_snd_devdata = {
	  ...
	  .codec_data = &rockchip_wm8994_setup,
};

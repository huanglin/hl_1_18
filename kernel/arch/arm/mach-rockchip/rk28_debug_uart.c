...
#endif
#ifdef CONFIG_RK2818_A7
#define UART_OUT_REG                UART0_BASE_ADDR
#else
#define UART_OUT_REG                UART1_BASE_ADDR
#endif
#define TIMER_GPIO                      GPIOPortE_Pin2 // GPIOPortA_Pin0
...
static pUART_REG g_UART =((pUART_REG)(( UART_OUT_REG)));
...
//	uart_reset(puartreg);  
   ...
   /// UARTSetIntEnabled(puartreg,uartIntNumb);
        ...
        g_UART =((pUART_REG)(IO_PA2VA_APB( UART_OUT_REG)));
         ...
         */
        TIMER_GPIO_INIT();  
        printk("%s:just after map board io\n",__func__);
        return (0);
}

                 ...
                 union iwreq_data *wrqu, char *extra)
{
	...
	printk("Enter ar6000_ioctl_siwpower\n");

    if (ar->arWlanState == WLAN_DISABLED) {
		printk("arWlanState == WLAN_DISABLED\n");
        return -EIO;
    }
...
/****************************hhy****************/
     ...
     {   
		printk("%s: Ignore this scan due to deep sleep.\n",__func__);
        #if 0
         union iwreq_data wrqu;
         A_MEMZERO(&wrqu, sizeof(wrqu));
//         memset(&(wrqu.data), 0, sizeof(struct iw_point));
        ...
        wireless_send_event(ar->arNetDev, SIOCGIWAP, &wrqu, NULL);
         ...
         if((wifi_ps_status == WIFI_PS_DRV_SLEEP) && (ar->wifi_ps_work_req == WIFI_PS_AWAKE))
         {
            printk("ar6000_ioctl_siwscan:Wakeup wifi for scan.\n");

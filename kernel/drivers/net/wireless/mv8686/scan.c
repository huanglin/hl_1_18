...
int lbs_scan_networks(struct lbs_private *priv, int full_scan)
{
	...
	printk("lbs_scan_networks: full_scan=%d ssid_len=%d ssid=%s\n", 
	       full_scan, priv->scan_ssid_len, priv->scan_ssid);
		 ...
		 union iwreq_data *wrqu, char *extra)
{
	    ...
	    wrqu->data.flags & IW_SCAN_THIS_ESSID) 
	{
		...
		printk("Special scanning, essid '%s'\n",
			print_ssid(ssid, req->essid, req->essid_len));
	} 
#endif
	//else
	{
    ...
    {
        //printk("scan_req: ssid_len=%d ssid=%s\n", 
        //       scan_req->ssid_len, scan_req->ssid);

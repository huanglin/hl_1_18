...
#else
#define SPIM_CS0_OUT             
#define SPIM_CS0_HIGH             
#define SPIM_CS0_LOW 
#endif
#define SPIM_CS1_OUT               __raw_writel(__raw_readl(GPIO0_BASE_ADDR_VA + 0x04) | 0x10 ,(GPIO0_BASE_ADDR_VA + 0x04))
#define SPIM_CS1_HIGH              __raw_writel(__raw_readl(GPIO0_BASE_ADDR_VA + 0x00) | 0x10 , (GPIO0_BASE_ADDR_VA + 0x00))
#define SPIM_CS1_LOW               __raw_writel(__raw_readl(GPIO0_BASE_ADDR_VA + 0x00) & (~0x10),(GPIO0_BASE_ADDR_VA + 0x00))
...
arch_initcall_sync(rockchip_spim_init);

...
u8 ANX7150_Config_Packet(void);
u8 ANX7150_Load_Infoframe(packet_type member, infoframe_struct *p);

u8 ANX7150_Checksum(infoframe_struct *p);
u8 ANX7150_Config_Audio(void);
u8 ANX7150_Config_I2s(void);
u8 ANX7150_Config_Spdif(void);
u8 ANX7150_Config_Super_Audio(void);
...
void ANX7150_Video_Clock_Change(void);
...
void ANX7150_Rx_Sense(void);
void ANX7150_HDCPLINK_CHK(void);
...
void ANX7150_Set_System_State(u8 ss);
...
u8 ANX7150_Parse_ExtBlock(void);
void ANX7150_GetEDIDLength(void);
u8 ANX7150_EDID_Checksum(u8 block_number) ;
void ANX7150_InitDDC_Read(u8 devaddr, u8 segmentpointer,u8 offset, u8  access_num_Low,u8 access_num_high);
...
u8 ANX7150_DDC_Check_Status(ANX7150_DDC_Status_Check_Type DDC_status_need_type, u8 status_u8);
u8 ANX7150_DDC_Count_Compare(u8 length);
u8 ANX7150_DDC_Read(ANX7150_DDC_Addr ddc_address, const u8 *DDC_data, WORD length, ANX7150_DDC_Type DDC_type);
//u8 ANX7150_DDC_Write(ANX7150_DDC_Addr ddc_address, const u8 *DDC_data, WORD length, ANX7150_DDC_Type DDC_type);//wen
/*end*/
...
//u8 ANX7150_Check_KSV_SRM(void);//wen
void HDMI_Set_Auto_Detect(u8 mode); //Set HDMI work mode for ANX7150
u8 HDMI_Get_Auto_Detect(void); //ANX7150 call this to check work mode
void  HDMI_Set_HPD(u8 hpd); //ANX7150 Set HPD flag for CPU
u8  HDMI_Get_HPD(void);//CPU call this funtion to check HPD
void  HDMI_Set_Lowpower(u8 lowpower); //CPU set the lowpower mode
u8  HDMI_Get_Lowpower( void); //ANX7150 call this to check lowpower
...
void ANX7150_API_HoldSystemConfig(u8 bHold_ANX7150);
...
void ANX7150_API_Audio_Config(u8 aud_fs);

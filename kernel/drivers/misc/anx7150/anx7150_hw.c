...
u8 ANX7150_system_state = INITIAL;
...
int ANX7150_GET_SENSE_STATE(void)
{
	unsigned char c;
...
void ANX7150_Video_Format_Change(void)
{
    u8 c;
...
void ANX7150_Audio_CLK_Change(void)
{
    u8 c;
...
void ANX7150_AFIFO_Overrun(void)
{
    u8 c;
...
void ANX7150_SPDIF_Error(int cur_state, int SPDIF_bi_phase_err, int SPDIF_error)
{
	int state = cur_state;
	u8 c;
...
//		D("enter\n");
		...
		if( c & ANX7150_HDMI_AUDCTRL1_SPDIFIN_EN)	
		{
		    ...
		    if (spdif_error_cnt >= spdif_error_th)
		    {
		        ...
		        D("adjust mclk phase!\n");
		        ANX7150_i2c_read_p0_reg(ANX7150_HDMI_AUDCTRL0_REG, &c2);
		        ...
		        switch (freq_mclk)
		        {
		            case ANX7150_mclk_128_Fs:   //invert 0x50[3]
		                ...
		                ANX7150_i2c_write_p0_reg(ANX7150_HDMI_AUDCTRL0_REG, c2);
		                break;
...
void ANX7150_Rx_Sense_Change(int cur_state)
{
	int state = cur_state;
    u8 c;
...
void ANX7150_HDCPLINK_Change(void)
{
    u8 c,c1, ri0,ri1;
...
//******************************Video Config***************************************
int ANX7150_Config_Video(void)
{
    u8 c,TX_is_HDMI;
    u8 cspace_y2r, y2r_sel, up_sample,range_y2r;
    ...
    ANX7150_i2c_write_p0_reg(ANX7150_VID_CTRL_REG, c & (~ANX7150_VID_CTRL_u8CTRL_EN));
/*
...
*/
    ...
    if (ANX7150_demux_yc_en)
    {
        ...
        {
            ANX7150_i2c_read_p0_reg(ANX7150_VID_CTRL_REG, &c);
            ANX7150_i2c_write_p0_reg(ANX7150_VID_CTRL_REG, c | ANX7150_VID_CTRL_YCu8_SEL);
            //jack wen, u8 mapping for yc mux, D3-8,1-0 -->D1-4
            D("ANX7150_demux_yc_en!####D1-4\n");

            ANX7150_i2c_read_p0_reg(ANX7150_VID_CTRL_REG, &c);
            ANX7150_i2c_write_p0_reg(ANX7150_VID_CTRL_REG, c | ANX7150_VID_CTRL_u8CTRL_EN);

            ANX7150_i2c_write_p0_reg(VID_u8_CTRL11,  0x0d);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL10,  0x0c);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL9,  0x0b);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL8,  0x0a);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL7,  0x09);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL6,  0x08);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL5,  0x01);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL4,  0x00);
        ...
        else
        {
            ...
            D("ANX7150_demux_yc_en!####D5-8\n");

            ANX7150_i2c_read_p0_reg(ANX7150_VID_CTRL_REG, &c);
            ANX7150_i2c_write_p0_reg(ANX7150_VID_CTRL_REG, c | ANX7150_VID_CTRL_u8CTRL_EN);

            ANX7150_i2c_write_p0_reg(VID_u8_CTRL15, 0x0d);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL14, 0x0c);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL13,  0x0b);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL12, 0x0a);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL11, 0x09);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL10, 0x08);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL9, 0x01);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL8, 0x00);
            //
    ...
    if (ANX7150_ddr_bus_mode)
    {
        ...
        ANX7150_i2c_read_p0_reg(ANX7150_VID_CTRL_REG, &c); //u8 map for
        ANX7150_i2c_write_p0_reg(ANX7150_VID_CTRL_REG, c |ANX7150_VID_CTRL_YCu8_SEL);
        //jack wen
        ...
        if (ANX7150_video_format_config == 0x07)//jack wen, DDR yc422, 601,
        {
            ...
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL23,  0x0B);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL22,  0x0A);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL21,  0x09);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL20,  0x08);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL19,  0x07);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL18,  0x06);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL17,  0x05);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL16, 0x04);

            ANX7150_i2c_write_p0_reg(VID_u8_CTRL15,  0x17);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL14,  0x16);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL13,  0x15);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL12,  0x14);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL11,  0x13);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL10,  0x12);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL9,  0x11);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL8,  0x10);

            ANX7150_i2c_write_p0_reg(VID_u8_CTRL7,  0x03);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL6,  0x02);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL5,  0x01);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL4,  0x00);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL3,  0x0F);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL2,  0x0E);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL1, 0x0D);
            ANX7150_i2c_write_p0_reg(VID_u8_CTRL0,  0x0C);
	...
	DRVDelayMs(60); /* wait for vedio stable */
...
{
    u8 c,video_type,hsync_pol,vsync_pol,v_fp,v_bp,vsync_width;
...
{
    u8 c,video_type,hsync_pol,vsync_pol,v_fp,vsync_width;
...
void ANX7150_Show_Video_Parameter()
{
    ...
    I("\n");
    {
        I("   Normal mode output video format: \n");
        switch (ANX7150_video_timing_id)
        {
            case ANX7150_V720x480p_60Hz_4x3:
            case ANX7150_V720x480p_60Hz_16x9:
                ...
                if (ANX7150_edid_result.supported_720x480p_60Hz)
                    I("and sink supports this format.\n");
                else
                    I("but sink does not support this format.\n");
                break;
            case ANX7150_V1280x720p_60Hz:
                I("1280x720p@60\n");
    ...
    if (c1)//HDMI output
    {
        ...
        if	(ANX7150_HDCP_enable == 1)
            I("   ANX7150_HDCP_Enable.\n");
        else
            I("   ANX7150_HDCP_Disable.\n");
...
u8 ANX7150_Config_Audio()
{
    ...
    else
    {
        ...
        ANX7150_i2c_write_p0_reg(ANX7150_ONEu8_AUD_CTRL_REG, 0x00);
    }
    ...
    if (s_ANX7150_audio_config.audio_type & ANX7150_super_audio_input)
    {
        ANX7150_i2c_read_p0_reg(ANX7150_ONEu8_AUD_CTRL_REG, &c);
        if ( c & 0xfc)      //u8[5:3]
        {
            audio_layout = 0x80;
        }
...
u8 ANX7150_Config_Super_Audio()
{
    ...
    ANX7150_i2c_write_p0_reg(ANX7150_ONEu8_AUD_CTRL_REG, c);
...
u8 ANX7150_Load_Infoframe(packet_type member,
                             infoframe_struct *p)
{
    u8 exe_result = 0x00;
    ...
    {
        ANX7150_i2c_write_p1_reg(address[member]+3+i, p->pb_u8[i]);
        ANX7150_i2c_read_p1_reg(address[member]+3+i, &c);
    }
    return exe_result;
}

u8 ANX7150_Checksum(infoframe_struct *p)
{
    u8 checksum = 0x00;
    u8 i;
...
/*
u8 ANX7150_Load_Packet(packet_type member,
                            infoframe_struct *p)
{
    u8 exe_result = 0x00;
    u8 address[8] = {0x00,0x20,0x40,0x60,0x80,0x80,0xa0,0xa0};
...
u8 ANX7150_IS_KSVList_VLD(void)
{
//wen HDCP CTS
#if 1
    D("ANX7150_IS_KSVList_VLD() is called.\n");
    ANX7150_InitDDC_Read(0x74, 0x00, 0x41, 0x02, 0x00); //Bstatus, two u8s
    DRVDelayMs(5);
...
void ANX7150_Set_System_State(u8 new_state)
{
...
int ANX7150_Interrupt_Process(struct anx7150_dev_s *dev, int cur_state)
{
...
//	D("enter\n");
	...
	hot_plug = ANX7150_GET_HPD();

	ret = ANX7150_Get_Interrupt_status(&interrupt_staus);
	if(ret < 0){
		goto out;
	}	

	if(dev->HPD_status != hot_plug){
		dev->HPD_change_cnt++;
	}
	else{
		dev->HPD_change_cnt = 0;
	}

	if(dev->HPD_change_cnt > 1){
		D("hotplug_change\n");

		if(hot_plug == HDMI_RECIVER_UNPLUG){
			ANX7150_Unplug();
			state = INITIAL;
			dev->reciver_status = HDMI_RECIVER_INACTIVE;
			dev->notifier_callback(dev); /* reciver status change */
		}

		dev->HPD_change_cnt = 0;
		dev->HPD_status = hot_plug;
	}

	if(state != INITIAL && state != WAIT_HOTPLUG){
		if(interrupt_staus.video_format_change){
			if(state > SYSTEM_CONFIG){
				ANX7150_Video_Format_Change();
				state = CONFIG_VIDEO;
			}
		}
		...
		if(ANX7150_GET_RECIVER_TYPE() == 1){
			...
			if(interrupt_staus.audio_FIFO_overrun){
				if(state > CONFIG_VIDEO){
					ANX7150_AFIFO_Overrun();
					state = CONFIG_AUDIO;
				}
			}

			ANX7150_SPDIF_Error(state, interrupt_staus.SPDIF_bi_phase_error, interrupt_staus.SPDIF_error);
		}
...
void ANX7150_Shutdown(void)
{
	I("enter\n");
	ANX7150_API_Initial();
	ANX7150_Set_System_State(INITIAL);
}

/*void ANX7150_Interrupt_Information(u8 c, u8 n)
{
    u8 TX_is_HDMI,c1;
...
//	D("enter\n");
	...
	ret = ANX7150_i2c_read_p0_reg(ANX7150_SYS_CTRL3_REG, &sys_ctl3);
	if(ret < 0)
		goto out;

	if(sys_ctl3 & ANX7150_SYS_CTRL3_PWON_ALL){
		/* normal mode */
		ret = ANX7150_i2c_read_p0_reg(ANX7150_SYS_STATE_REG, &sys_state);
		if(ret < 0)
			goto out;

		if(sys_state & ANX7150_SYS_STATE_HP)
			hpd_state = 1;
		else
			hpd_state = 0;
	}
		...
		/* stanby mode */
		ret = ANX7150_i2c_read_p0_reg(ANX7150_INTR_STATE_REG, &intr_state);
		if(ret < 0)
			goto out;
...
int ANX7150_Get_Interrupt_status(struct anx7150_interrupt_s *interrupt_staus)
{
	int ret;
	u8 int_s1;
	u8 int_s2;
...
//	D("enter\n");
    ...
    ret = ANX7150_i2c_read_p0_reg(ANX7150_INTR1_STATUS_REG, &int_s1);
    ret |= ANX7150_i2c_write_p0_reg(ANX7150_INTR1_STATUS_REG, int_s1);

    ret |= ANX7150_i2c_read_p0_reg(ANX7150_INTR2_STATUS_REG, &int_s2);
    ret |= ANX7150_i2c_write_p0_reg(ANX7150_INTR2_STATUS_REG, int_s2);

    ret |= ANX7150_i2c_read_p0_reg(ANX7150_INTR3_STATUS_REG, &int_s3);
    ret |= ANX7150_i2c_write_p0_reg(ANX7150_INTR3_STATUS_REG, int_s3);
...
int ANX7150_Parse_EDID(struct anx7150_dev_s *dev)
{
    u8 c, i;
    ...
    {
        E("BAD EDID Header, Stop parsing \n");
    ...
    {
        E("EDID does not support 861B, Stop parsing\n");
...
*/
    ...
    if (ANX7150_edid_result.edid_errcode == ANX7150_EDID_ExtBlock_NotFor_861B){
		E("EDID ExtBlock not support for 861B, Stop parsing\n");
        goto err;
    }

    if (ANX7150_edid_result.edid_errcode == ANX7150_EDID_CheckSum_ERR){
		E("EDID Block check sum error, Stop parsing\n");
        goto err;
    }
...
int ANX7150_Get_Optimal_resolution(int resolution_set)
{
	...
	case HDMI_720x576p_50Hz:
		...
		break;
	default:
		E("Invalid resolution, resolution_set = %d\n", resolution_set);
		break;
	}

	if(find_resolution == 0){
		I("resolution_set doesn't supported!\n");
...
void ANX7150_DDC_Mass_Read(WORD length, u8 segment)
{
    WORD i, j;
    u8 c, c1,ddc_empty_cnt;
    ...
    while (i > 0)
    {
        ...
        if (ANX7150_ddc_fifo_full)
        {
            ...
            for (j=0; j<c; j++)
            {
                ...
                ANX7150_ddc_fifo_full = 0;
				if(anx7150_mass_read_need_delay && !(j&0x03)){
					DRVDelayMs(1);
				}
            }
            i = i - c;
...
u8 ANX7150_Parse_EDIDHeader(void)
{
    u8 i,temp;
    temp = 0;
...
u8 ANX7150_Parse_EDIDVersion(void)
{
...
{
    u8 temp;
    temp = ANX7150_Read_EDID_u8(0,0x18) & 0x18;
    	if(temp == 0x00)
    ...
    temp = ANX7150_Read_EDID_u8(0,0x18) & 0x02;
    if(temp == 0x00)
...
u8 ANX7150_EDID_Checksum(u8 block_number)
{
    u8 i, real_checksum;
...
void ANX7150_InitDDC_Read(u8 devaddr, u8 segmentpointer,
...
u8 ANX7150_Read_EDID_u8(u8 segmentpointer,u8 offset)
{
    /*u8 c;
...
u8 ANX7150_DDC_Parameter_Validity(u8 *Addr,WORD length)
{
    if (Addr == NULL)
    {
...
{
    u8 length_low,length_high;

    D("!!!!DDC_data_number :%x\n",length);
    length_high = (u8)((length >> 8) & 0xff);
    length_low = (u8)(length & 0xff);
    /*set number of u8s to DDC channel*/
...
/*Return  :None*/
void ANX7150_DDC_Command(u8 DDC_command)
{
    /*set DDC command*/
...
/*Parameter :   DDC_status_need_type,status_u8*/
/*Return  :always is 0 if DDC_status_need_status is "report",or return DDC status u8 value
if DDC_status_need_type is "Judge"*/
u8 ANX7150_DDC_Check_Status(ANX7150_DDC_Status_Check_Type DDC_status_need_type,
                               u8 status_u8)
{
    u8 DDC_status,i,j;
    char *status[8] =
    ...
    {
        return ((DDC_status >> status_u8) & 0x01 );
    }
}
...
u8 ANX7150_DDC_Count_Compare(u8 length)
{
    u8 Fifo_Count;
...
u8 ANX7150_DDC_Read (ANX7150_DDC_Addr ddc_address, const u8 *DDC_data,
                        WORD length, ANX7150_DDC_Type DDC_type)
{
    u8 DDC_Err,fifo_read_data_compare;
    int data_cnt;
    int fifo_data_cnt;
    u8 *Fifo_Read_P;
    ...
    */ 																																		//update
    ...
    ANX7150_DDC_Command((u8)Clear_DDC_Fifo);

    /*check DDC channel status*/
    if (!ANX7150_DDC_Check_Status(Judge, DDC_Error_u8) &&
            !ANX7150_DDC_Check_Status(Judge, DDC_Occup_u8) &&
            !ANX7150_DDC_Check_Status(Judge, DDC_No_Ack_u8))
    {
        /*send "sequential u8 read"command if check success*/
        ANX7150_DDC_Command((u8)Sequential_u8_Read);
        /*delay*/
    ...
    do
    {
        ...
        if (fifo_data_cnt <= DDC_Fifo_Depth)
        {
            ...
            /*check u8 DDC_Progress of DDC status,fifo count*/
            if (!ANX7150_DDC_Check_Status(Judge, DDC_Progress_u8) &&
        ...
        {
            /*check u8 DDC_Progress of DDC status,Fifo_full*/
            if (ANX7150_DDC_Check_Status(Judge, DDC_Progress_u8) &&
                    ANX7150_DDC_Check_Status(Judge, DDC_Fifo_Full_u8))
            {
...
/*					//wen
u8 ANX7150_DDC_Write (ANX7150_DDC_Addr ddc_address, const u8 *DDC_data,
    WORD length, ANX7150_DDC_Type DDC_type)
{
    u8 DDC_Err,fifo_write_data_compare;
    int data_cnt;
    int fifo_data_cnt;
    u8 *Fifo_Write_P;
        ...
        !ANX7150_DDC_Check_Status(Judge, DDC_No_Ack_u8)){
            ...
            do {
                ...
                if (fifo_data_cnt <= DDC_Fifo_Depth){
                    ...
                    //send "sequential u8 write"command after finish writing data to fifo
                    ANX7150_DDC_Command((u8)Sequential_u8_Write);
                    //delay
...
void ANX7150_API_Video_Config(u8 video_id,u8 input_pixel_rpt_time)
{
    ANX7150_video_timing_id = video_id;
    ANX7150_in_pix_rpt = input_pixel_rpt_time;
}

void ANX7150_API_Packets_Config(u8 pkt_sel)
{
    s_ANX7150_packet_config.packets_need_config = pkt_sel;
}

void ANX7150_API_AUD_CHStatus_Config(u8 MODE,u8 PCM_MODE,u8 SW_CPRGT,u8 NON_PCM,
...
void ANX7150_API_AVI_Config(u8 pb1,u8 pb2,u8 pb3,u8 pb4,u8 pb5,
...
void ANX7150_API_AUD_INFO_Config(u8 pb1,u8 pb2,u8 pb3,u8 pb4,u8 pb5,

...
#define OUT_P24BPP4         28  //rk-epd ctrl mode
...
#define FB0_IOCTL_SET_DITHER		    0x6009
#define FB0_IOCTL_GET_MODE		        0x600a
#define FB0_SET_WAVEFORM_DATA              0x600b
#define FB0_SET_TEST_TEMPERTURE          0x600c
#define FB0_SET_TEST_MODE				0x600d
